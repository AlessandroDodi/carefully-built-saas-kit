...
import { ErrorCode } from "@/components/ui/error-page/error-code";
import {
  getNotFoundPageContent,
  resolveErrorPageContent,
  type ErrorPageContent,
} from "@/components/ui/error-page/error-page-content";
import { captureErrorToPostHog, createErrorReference } from "@/components/ui/error-page/posthog-error-capture";
